...
from nets.resnext import resnext50_32x4d, resnext101_32x8d
...
class Model(nn.Module):
    ...
    def forward(self, inputs, targets, meta_info, mode):
        ...
        with cm:
            ...
            # meshnet forward
            _, mesh_img_feat = self.mesh_backbone(shared_img_feat)
...
def get_model(vertex_num, joint_num, mode):
    pose_backbone = resnext50_32x4d(pretrained=True, skip_early=False)

    pose_net = PoseNet(joint_num)
    pose2feat = Pose2Feat(joint_num)

    mesh_backbone = resnext101_32x8d(pretrained=True, skip_early=True)
